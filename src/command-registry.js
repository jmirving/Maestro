...
const COMMANDS = [
  ...
  },
  {
    name: "reconcile",
    category: "Advanced / debugging",
    summary: "Recover validator-approved work from an integration-time Git rebase conflict.",
    ...
    effects: "Rebases the existing implementation, delegates conflict-only repair if needed, then freshly validates a child run.",
    cautions: "Git conflict recovery is not manifest/GitHub reconciliation. Resolving a conflict does not approve, complete, or integrate the issue.",
    next: ["maestro status", "maestro details <issue>", "maestro approve <issue>"],
